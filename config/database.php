    ...
    */
    ...
    'connections' => [
        ...
        'landlord' => [
            'driver'         => 'mysql',
            'url'            => env('DB_URL'),
            'host'           => env('DB_HOST', env('DB_LANDLORD_HOST', '127.0.0.1')),
            'port'           => env('DB_PORT', env('DB_LANDLORD_PORT', '3306')),
            'database'       => env('DB_DATABASE', env('DB_LANDLORD_DATABASE', 'jectstore_central')),
            'username'       => env('DB_USERNAME', env('DB_LANDLORD_USERNAME', 'root')),
            'password'       => env('DB_PASSWORD', env('DB_LANDLORD_PASSWORD', '')),
            'unix_socket'    => env('DB_SOCKET', ''),
            'charset'        => env('DB_CHARSET', 'utf8mb4'),
            'collation'      => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix'         => env('DB_PREFIX', ''),
