    ...
    install(app) {
        app.config.globalProperties.$admin = {
            ...
            formatPrice: (price) => {
                ...
                const isCop = currency.code?.toUpperCase() === 'COP';
                ...
                if (! currency.currency_position) {
                    return new Intl.NumberFormat(locale, {
                        ...
                        minimumFractionDigits: isCop ? 0 : undefined,
                        maximumFractionDigits: isCop ? 0 : undefined,
                    }).format(price);
                }
                ...
                const formatter = new Intl.NumberFormat(locale, {
                    style: 'currency',
                    currency: currency.code,
                    minimumFractionDigits: isCop ? 0 : (currency.decimal ?? 2),
                    maximumFractionDigits: isCop ? 0 : (currency.decimal ?? 2),
                });
