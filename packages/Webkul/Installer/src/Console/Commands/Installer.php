...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $description = 'JectStore installer.';
    ...
    public function handle(): void
    {
        ...
        $this->warn('Step: Seeding basic data for JectStore kickstart...');
    ...
    protected function askForApplicationDetails(): void
    {
        $this->updateTextTypeEnv(
            ...
            $this->getEnvVariable('APP_NAME', 'JectStore')
        );
    ...
    protected function askForAdminDetails()
    {
        ...
        try {
            ...
            File::put($filePath, 'JectStore is successfully installed.');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use JectStore.');
