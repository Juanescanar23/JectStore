    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                ...
                'bagisto'      => 'JectStore 安装',
                'title'        => '安装',
            ],

            'installation-completed' => [
                'admin-panel'                => '管理员面板',
                'bagisto-forums'             => 'JectStore 论坛',
                'customer-panel'             => '客户面板',
                'explore-bagisto-extensions' => '探索 JectStore 扩展',
                'title'                      => '安装已完成',
                'title-info'                 => 'JectStore 已成功安装在您的系统上。',
            ],

            'ready-for-installation' => [
                'create-databsae-table'   => '创建数据库表',
                'install'                 => '安装',
                'install-info'            => 'JectStore 安装信息',
            ...
            'start' => [
                ...
                'title'         => '您的 JectStore 安装',
                'welcome-title' => '欢迎来到 JectStore',
            ],
            ...
            'hindi'                    => '印地语',
            'indonesian'               => '印尼语',
            'installation-description' => 'JectStore 的安装通常涉及几个步骤。以下是 JectStore 安装过程的一般概述',
            'installation-info'        => '我们很高兴在这里见到你！',
            'installation-title'       => '欢迎安装 JectStore',
            'italian'                  => '意大利语',
            'japanese'                 => '日语',
            'persian'                  => '波斯语',
            'polish'                   => '波兰语',
