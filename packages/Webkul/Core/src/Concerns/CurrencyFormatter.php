...
trait CurrencyFormatter
{
    ...
    {
        $isCop = strtoupper($currency->code) === 'COP';
        ...
        if ($currency->currency_position) {
            return $this->useCustomCurrencyFormatter($price, $currency, $isCop);
        }

        return $this->useDefaultCurrencyFormatter($price, $currency, $isCop);
    }

    /**
     * Use default formatter.
     */
    public function useDefaultCurrencyFormatter(?float $price, Currency $currency, bool $isCop = false): string
    {
     ...
     */
    public function useCustomCurrencyFormatter(?float $price, Currency $currency, bool $isCop = false): string
    {
        $formatter = new \NumberFormatter(app()->getLocale(), \NumberFormatter::CURRENCY);
